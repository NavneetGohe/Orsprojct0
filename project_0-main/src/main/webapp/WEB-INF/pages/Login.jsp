...
body {
	background-image:
		url("http://localhost:8085/orsproject0/resources/img/A7.jpg");
					...
					<div>
						...
						<sf:form class="register-form" method="POST" modelAttribute="form">
							...
							<center>
								...
								<button class="btn btn-success" name="operation" value="SignIn">
									<s:message code="label.login" />
								</button>
								<button class="btn btn-danger" name="operation" value="SignUp">
