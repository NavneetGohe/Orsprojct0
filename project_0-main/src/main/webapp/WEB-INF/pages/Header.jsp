...
<div class="container-fluid">
	...
	<a class="navbar-brand" href='<c:url value="/Welcome"></c:url>'><img class="im1"
		src='<c:url value="http://localhost:8080/orsproject0/resources/img/img4.png"></c:url>'></a>
		
	
	<%--  <a class="text-warning bg-success circle p-1 m-0" 
	 	href='<c:url value="?lang=en"></c:url>'><strong class="text-dark">English</strong></a><br> <a
		class="text-dark bg-danger circle p-1 m-0"
	...
	<div class="collapse navbar-collapse" id="navbarNav">
		<ul class="nav navbar-nav ml-auto">
		 ...
		 <button class ="btn-sm btn-success ig" ><a class="text-warning  circle p-1 m-0" id ="GFG"
	 	href='<c:url value="?lang=en"></c:url>'><strong class="text-dark">English</strong></a></button>
	 	<button  class ="btn-sm btn-warning ig"><a
		class="text-dark  circle p-1 m-0" id="GFG"
		href="<c:url value="?lang=hi"></c:url>"><strong>हिन्दी</strong></a></button>
