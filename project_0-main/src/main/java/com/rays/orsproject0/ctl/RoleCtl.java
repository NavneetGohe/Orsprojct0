...
public class RoleCtl extends BaseCtl {
	 ...
	 * @param form:   Object of RoleForm
	 * @param model:  Object of Model Interface
	 * @return Role: View of Role Form
	 */
	...
	public String submit(@RequestParam String operation, Model model, @ModelAttribute("form") @Valid RoleForm form,
	 ...
	 * @param form:   Object of RoleForm
	 * @param model:  Object of Model Interface
	 * @return RoleList: View of RoleList
	 */
	...
	public String display(@ModelAttribute("form") RoleForm form, Model model, Locale locale) {
		...
		List lis = service.search(null);
		model.addAttribute("rolelist", lis);
		System.out.println("get model lis" + lis.size() );
//		model.addAttribute("findList", service.search(null));
	...
	public String submit(@RequestParam(required = false) String operation, @ModelAttribute("form") RoleForm form,
		...
		RoleDTO dto = (RoleDTO) form.getDto();
		System.out.println("  chech kk "  + dto.getId() + dto.getRoleName());
		List list = service.search(dto, pageNo, form.getPageSize());
		System.out.println(" chechk ctl " + list.size());
